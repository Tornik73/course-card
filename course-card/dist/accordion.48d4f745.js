...
if (db["level"] === 1) {
  var level_text = document.getElementById("level__block-txt").innerHTML += 'Контентний';
}

if (db["level"] === 2) {
  var _level_text = document.getElementById("level__block-txt").innerHTML += 'Інтерактивний';
}

if (db["level"] === 3) {
  var _level_text2 = document.getElementById("level__block-txt").innerHTML += 'Автономний';
}

if (db["level"] === 0) {
  var _level_text3 = document.getElementById("level__block-txt").innerHTML += 'Відсутній';
